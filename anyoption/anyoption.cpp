...
// Hack to get it to commpile on not-Windows.
static int strcpy_s(char* destination, size_t num, const char * source)
{
    strncpy(destination, source, num);
    return 0;
}

static int strcpy_s(char* destination, const char * source)
{
